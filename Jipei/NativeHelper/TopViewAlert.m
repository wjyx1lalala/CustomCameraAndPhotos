...
- (void)setUpUI{
    ...
    _label.textColor = [UIColor colorWithRed:.278 green:.278 blue:.278 alpha:1];
...
+ (void)showWithMessage:(NSString *)message{
    ...
    alert.isShow = YES;
    [UIView animateWithDuration:.4 delay:0 usingSpringWithDamping:.35 initialSpringVelocity:10 options:UIViewAnimationOptionLayoutSubviews animations:^{
        CGRect rect =  alert.frame;
        rect.origin.y = -20;
        alert.frame = rect;
