...
- (void)viewDidLoad {
    [super viewDidLoad];
    _dataArr =  [[PhotosLoader sharePhotoTool] getPhotoAblumList];
    NSLog(@"%@",_dataArr);
    _dataArr = [[NSMutableArray alloc]init];
//    self.view.backgroundColor = [UIColor whiteColor];
//    //调用这个方法获取相册里的所有图片
//    [_dataArr addObjectsFromArray:[[PhotosLoader sharePhotoTool] getAllAssetInPhotoAblumWithAscending:NO]];
...
//    UIImageView * imgV = [UIImageView alloc] initWithImage:<#(nullable UIImage *)#>
...
- (void)getImageWithAsset:(PHAsset *)asset completion:(void (^)(UIImage *image))completion
{
    ...
    [[PhotosLoader sharePhotoTool] requestImageForAsset:asset size:size resizeMode:PHImageRequestOptionsResizeModeFast completion:completion];
}
